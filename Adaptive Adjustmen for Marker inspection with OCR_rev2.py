...
def process_image(image):
    ...
    # Ensure block_size and other parameters are valid
    if block_size % 2 == 0:
        block_size += 1
    if block_size < 3:
        block_size = 3
    ...
    cv2.rectangle(image, (crop_coords[0], crop_coords[1]), (crop_coords[2], crop_coords[3]), (0, 255, 0), 2)
...
def capture_frame():
    ...
    # Display the captured image with the OCR result
